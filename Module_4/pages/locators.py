...
class LoginPageLocators:
    ...
    REGISTER_FORM_INPUT_EMAIL_FIELD = (By.ID, 'id_registration-email')
    REGISTER_FORM_INPUT_PASSWORD_FIELD_1 = (By.ID, 'id_registration-password1')
    REGISTER_FORM_INPUT_PASSWORD_FIELD_2 = (By.ID, 'id_registration-password2')
